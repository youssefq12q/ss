...
export default function UserProfileDropdown({
  ...
  const [activeSubTab, setActiveSubTab] = React.useState<
    "overview" | "rewards" | "notifications"
  >("overview");
                  ...
                  <div className="relative z-10 space-y-3">
                    ...
                    <div className="pt-2 flex justify-between items-end border-t border-white/10">
                      ...
                      <button
                        ...
                        <p
                          className={`text-[8px] uppercase tracking-widest opacity-60 group-hover/pts:opacity-100 transition-opacity ${cardText}`}>
                          Point Balance 🎁
                        </p>
                        <p
                          className={`text-xs font-bold font-mono tracking-widest mt-0.5 underline underline-offset-2 decoration-brand-gold/50 group-hover/pts:text-brand-gold transition-colors ${cardText}`}>
            ...
            {notifications.length > 0 ? (
              ...
              <div className="text-center py-8 text-[#8c827a] text-xs space-y-1">
                ...
                <p className="text-[10px]">
                  ستتلقى إشعاراً عند الموافقة على تقييماتك أو الرد عليها من
                  الإدارة.
                </p>
              </div>
            )}
